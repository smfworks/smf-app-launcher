#!/bin/bash
# One-shot SMF App Launcher install for Hermes Desktop.
#
...
REPO="${REPO:-https://github.com/smfworks/smf-app-launcher.git}"
NAME=smf-app-launcher
...
echo "Then: Ctrl+K → Open SMF App Launcher. First app open may npm install."
